...
#change YOURUSER with your username for the mongodb database
#change YOURPASSWORD with your password for the mongodb database
#change YOURIP with your ip for the mongodb database
trials = MongoTrials('mongo://YOURUSER:YOURPASSWORD@YOURIP/admin/jobs?authSource=admin', exp_key='exp1')
best = fmin(objective,
            space=space,
            trials=trials,
            algo=tpe.suggest,
